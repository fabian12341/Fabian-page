...
import Image from "next/image"; // 🔥 IMPORTACIÓN correcta de Next.js
...
const techStyles: Record<string, { color: string; icon: JSX.Element }> = {
  "next.js": { color: "bg-black text-white", icon: <SiNextdotjs className="w-4 h-4" /> },
  "tailwind": { color: "bg-sky-400 text-white", icon: <SiTailwindcss className="w-4 h-4" /> },
  "vercel": { color: "bg-black text-white", icon: <SiVercel className="w-4 h-4" /> },
  "react": { color: "bg-blue-500 text-white", icon: <SiReact className="w-4 h-4" /> },
  "flask": { color: "bg-gray-800 text-white", icon: <SiFlask className="w-4 h-4" /> },
  "whisper": { color: "bg-purple-600 text-white", icon: <SiOpenai className="w-4 h-4" /> },
  "mySQL": { color: "bg-blue-700 text-white", icon: <SiMysql className="w-4 h-4" /> },
  "render": { color: "bg-indigo-600 text-white", icon: <SiRender className="w-4 h-4" /> },
  "python": { color: "bg-yellow-400 text-black", icon: <SiPython className="w-4 h-4" /> },
  "javascript": { color: "bg-yellow-300 text-black", icon: <SiJavascript className="w-4 h-4" /> },
  "postgreSQL": { color: "bg-blue-800 text-white", icon: <SiPostgresql className="w-4 h-4" /> },
  "typescript": { color: "bg-blue-600 text-white", icon: <SiTypescript className="w-4 h-4" /> },
};
...
const projects = [
  ...
  },
  {
    ...
    description: "A full-stack web page to generate quizzes and give retroactive feedback.",
    ...
    image: "/webDevelopment.png" // le puse imagen temporal si quieres luego la cambias
  },
];
